      ...
      <div className=" row mt-5">
        <div className="col-sm-12">
          <div className="row ">
            ...
            <div className=" col-lg-6 col-sm-12 p-lg-0 p-5">
              <h3 className="text-uppercase biography-header  mt-2  fw-medium fs-1 ">
                Historyof Janmabhoomi
              </h3>
              <p className="side-line-side position-relative fw-normal fs-5 ">
                Dr. Bhimrao Ambedkar
              </p>
              <div className="mb-3 mt-4">
                <p className="fs-4 fw-bold  ">Significance of Mhow</p>
                <p className="section-content fs-5 p- fw-normal lg-base mt-1">
              ...
              <div className="mb-3 mt-4">
                <p className="fs-4 fw-bold m-0">Janmabhoomi Smarak</p>
                <p className="section-content fs-5 fw-normal lh-base mt-1">
              ...
              <div className="mb-5 mt-4 ">
                <p className="fs-4 fw-bold m-0">Legacy</p>
                <p className="section-content fs-5  fw-normal lh-base mt-1">
