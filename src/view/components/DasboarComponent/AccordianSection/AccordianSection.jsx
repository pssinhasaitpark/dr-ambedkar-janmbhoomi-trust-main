          ...
          <div className="row m-0">
            <div className="col-sm-4 border border-dark rounded m-3 Accordian-width ">
              <ul className="fs-5 list-unstyled mt-3 mb-3  ">
                ...
                <Link to="/birth" className="text-dark text-decoration-none">
                  <li className="border-bottom border-2 justify-content-between d-flex   accordian-list fs-4 hover-li fw-normal">
                    The Birthplace
                    <GoChevronRight size={30} className="text-dark" />
                  </li>{" "}
                </Link>
                <Link to="/museum" className="text-dark text-decoration-none">
                  {" "}
                  <li className="border-bottom border-2 justify-content-between d-flex   accordian-list fs-4 hover-li fw-normal ">
                    Museum / Exhibits
                    <GoChevronRight size={30} className="text-dark" />
                ...
                <Link to="/gallery" className="text-dark text-decoration-none">
                  {" "}
            ...
            <div className="col-sm-4 border border-dark rounded m-3 Accordian-width mb-4">
              <ul className="fs-5 list-unstyled mt-3 mb-3  ">
                <Link to="/award" className="text-dark text-decoration-none">
                  <li className="border-bottom fs-4 justify-content-between d-flex  accordian-list hover-li fw-normal border-2">
                    Awards
                    <GoChevronRight size={30} className="text-dark" />
                  </li>{" "}
                ...
                <Link to="/legacy" className="text-dark text-decoration-none">
                  {" "}
                  <li className="border-bottom fs-4 justify-content-between d-flex  accordian-list hover-li fw-normal border-2">
                ...
                <Link to="/education" className="text-dark text-decoration-none">
                  {" "}
                  <li className="border-bottom fs-4 justify-content-between d-flex  accordian-list hover-li fw-normal border-2">
                ...
                <Link to="/achievement" className="text-dark text-decoration-none">
                  {" "}
            ...
            <div className="col-sm-4 border border-dark rounded m-3 Accordian-width mb-4">
              <ul className="fs-5 list-unstyled mt-3 mb-3  ">
                ...
                <Link to="/donation" className="text-dark text-decoration-none">
                  {" "}
                  <li className="border-bottom fs-4 justify-content-between d-flex  accordian-list hover-li fw-normal border-2">
                ...
                <Link to="/visit" className="text-dark text-decoration-none">
                  {" "}
                  <li className=" fs-4 justify-content-between d-flex  accordian-list hover-li fw-normal ">
                    Visitor Information
                    <GoChevronRight size={30} className="text-dark" />
